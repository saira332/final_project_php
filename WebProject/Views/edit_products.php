...
<?php
    ...
    if($con->connect_error)
    {
        ...
        {
            $edt = $_GET["edit"];
            $query="SELECT * FROM `products` WHERE id='$edt'";
        ...
        if(isset($_POST["edit_products"]))
        {
            ...
            $q = "UPDATE `products` SET `name`='$product_name',`price`='$product_price' WHERE id='$product_id'";
...
<div style="clear: both"></div>
        <h3 class="title">Update product <a href="Adminpanel.html"><i style="float:left" class="fas fa-arrow-left mr-3"></i></a></h3>
        <div class="table-responsive">
          ...
          <div align="center"><input type="submit" name="edit_products" value="Update product"/></div>
     </form>
